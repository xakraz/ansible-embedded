...
# Look for an Environment Variable ANSIBLE_CONSUL_URL
# This allow to overwrite the 'url' config option from 'consul.ini'
# and select a consul cluster dynamically at Ansible runtime.
ANSIBLE_CONSUL_URL = ''
...
class ConsulConfig(dict):
  ...
  def get_consul_api(self):
      ...
      if ANSIBLE_CONSUL_URL:
          from urlparse import urlparse
          o = urlparse(ANSIBLE_CONSUL_URL)
          if o.hostname:
              host = o.hostname
          if o.port:
              port = o.port
